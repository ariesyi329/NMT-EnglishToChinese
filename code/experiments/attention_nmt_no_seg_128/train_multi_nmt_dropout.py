...
from code.model.attention_nmt.multi_nmt_dropout import train
...
def main(job_id, params):
    ...
    validerr = train(saveto=params['model'][0],
					...
					'/home/yl3068/NMT/NMT-EnglishToChinese/data/en/train.en.tok.pkl'],
                                        ...
                                        use_dropout_rnn=params['use-dropout-rnn'][0])
    return validerr

if __name__ == '__main__':
    main(0, {
        'model': ['/home/yl3068/NMT/NMT-EnglishToChinese/code/experiments/attention_nmt_no_seg_128/model_multi_dropout.npz'],
        'dim_word': [128],
        'dim': [128],
        'n-words': [30000],
        'optimizer': ['adadelta'],
