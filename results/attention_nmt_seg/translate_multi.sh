...
THEANO_FLAGS=floatX=float32 python -u -m code.model.attention_nmt.multi_simple_translater -n \
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/code/experiments/attention_nmt_seg/model_multi.npz \
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/data/zh/seg/zh.train.seg.tok.pkl \
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/data/en/train.en.tok.pkl \
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/data/zh/seg/zh.test.seg.tok \
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/results/attention_nmt_seg/test.translation.seg.multi
