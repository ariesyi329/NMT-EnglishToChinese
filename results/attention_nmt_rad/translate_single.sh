...
cd ../..
THEANO_FLAGS=floatX=float32 python -u -m code.model.attention_nmt.simple_translater -n \
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/code/experiments/attention_nmt_rad/model_single_long.npz \
    ...
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/results/attention_nmt_rad/test.translation.rad.single
