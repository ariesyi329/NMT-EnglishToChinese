...
# on laptop
cd ../..
THEANO_FLAGS=floatX=float32 python -u -m code.model.attention_nmt.multi_simple_translater -n \
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/code/experiments/attention_nmt_rad/model_multi_long.npz \
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/data/zh/rad/zh.train.rad.tok.pkl \
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/data/en/train.en.tok.pkl \
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/data/zh/rad/zh.test.rad.tok \
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/results/attention_nmt_rad/test.translation.rad.multi
