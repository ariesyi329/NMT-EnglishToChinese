...
THEANO_FLAGS=floatX=float32 python -u -m code.model.attention_nmt.multi_simple_translater -n \
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/code/experiments/attention_nmt_no_seg/model_multi.npz \
    ...
    $HOME/Documents/Data\ Science/summer_2016/NMT/NMT-EnglishToChinese/results/attention_nmt_no_seg/test.translation.no_seg.multi
